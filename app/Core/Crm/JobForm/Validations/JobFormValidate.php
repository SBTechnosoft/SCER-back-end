...
class JobFormValidate
{
	...
	public function validate($request)
	{
		$rules = array(
			...
			'product_information'=>'regex:/^[a-zA-Z0-9 &_`#().\'-]+$/',
			'qty'=>'regex:/^[0-9]+$/',
			'tax'=>'regex:/^[0-9 .]+$/',
			'discount'=>'regex:/^[0-9 .]+$/',
			'additional_tax'=>'regex:/^[0-9 .]+$/',
			'price'=>'regex:/^[0-9 .]+$/',
			'labour_charge'=>'regex:/^[0-9 .]+$/',
			'advance'=>'regex:/^[0-9 .]+$/',
			'total'=>'regex:/^[0-9 .]+$/'
		);
		$messages = [
			...
			'product_information.regex' => 'product-information contains character from "a-zA-Z0-9 &_`#().\'-" only',
			...
			'additional_tax.regex' => 'additional_tax contains character from "0-9 ." only',
			'price.regex' => 'price contains character from "0-9 ." only',
			'labour_charge.regex' => 'labour_charge contains character from "0-9 ." only',
