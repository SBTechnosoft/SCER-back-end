	...
	public function mpdfGenerate($templateData,$status)
	{
		...
		if(strcmp($decodedBillData->salesType,"retail_sales")==0)
		{
			for($productArray=0;$productArray<count($decodedArray->inventory);$productArray++)
			{
				...
				$additionalTaxValue[$productArray] = ($decodedData[$productArray]->additionalTax/100)*$decodedArray->inventory[$productArray]->price;
				...
				$output =$output."".
				'<tr class="trhw" style="font-family: Calibri; text-align: left; height: 50px; background-color: transparent;">
   <td class="tg-m36b thsrno" style="font-size: 12px; height: 50px;">'.$index.'</td>
   <td class="tg-m36b theqp" style="font-size: 12px;  height: 50px;">'. $decodedData[$productArray]->productName.'</td>
   <td class="tg-ullm thsrno" style="font-size: 12px;  height: 50px; text-align: center;">'. $decodedArray->inventory[$productArray]->color.'</td>
   <td class="tg-ullm thsrno" style="font-size: 12px;  height: 50px; text-align: center;">'. $decodedArray->inventory[$productArray]->frameNo.'</td>
   <td class="tg-ullm thsrno" style="font-size: 12px;   height: 50px; text-align: center;">'. $decodedArray->inventory[$productArray]->qty.'</td>
   <td class="tg-ullm thsrno" style="font-size: 12px; height: 50px; text-align: center;">'. $decodedArray->inventory[$productArray]->price.'</td>
   <td class="tg-ullm thsrno" style="font-size: 12px;  height: 50px; text-align: center;">'. $discountValue[$productArray].'</td>
   <td class="tg-ullm thamt" style="font-size: 12px;  height: 50px; text-align: center;">'. $decodedData[$productArray]->vat.'</td>
   <td class="tg-ullm thamt" style="font-size: 12px; height: 50px; text-align: center;">'.$vatValue[$productArray].'</td>
   <td class="tg-ullm thamt" style="font-size: 12px;  height: 50px; text-align: center;">'.$decodedData[$productArray]->additionalTax.'</td>
   <td class="tg-ullm thamt" style="font-size: 12px;   height: 50px; text-align: center;">'.$additionalTaxValue[$productArray].'</td>
   <td class="tg-ullm thamt" style="font-size: 12px;  height: 50px; text-align: center;">'.$total[$productArray];
		...
		else
		{
			for($productArray=0;$productArray<count($decodedArray->inventory);$productArray++)
			{
				...
				<td class="tg-m36b thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 54.1333px; text-align: center; height: 50px;"><span style="color: #000000;">'.$index.'</span></td>
				<td class="tg-m36b theqp" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 207.45px; text-align: center; height: 50px;"><span style="color: #000000;">'. $decodedData[$productArray]->productName.'</span></td>
				<td class="tg-ullm thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 49.0833px; text-align: center; height: 50px;"><span style="color: #000000;">'. $decodedArray->inventory[$productArray]->color.'</span></td>
				<td class="tg-ullm thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 49.0833px; text-align: center; height: 50px;"><span style="color: #000000;">'. $decodedArray->inventory[$productArray]->frameNo.'</span></td>
				<td class="tg-ullm thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 49.0833px; text-align: center; height: 50px;"><span style="color: #000000;">'. $decodedArray->inventory[$productArray]->qty.'</span></td>
				<td class="tg-ullm thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 102.733px; text-align: center; height: 50px;"><span style="color: #000000;">'. $decodedArray->inventory[$productArray]->price.'</span></td>
				<td class="tg-ullm thsrno" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 143.15px; text-align: center; height: 50px;"><span style="color: #000000;">'. $discountValue[$productArray].'</span></td>
				<td class="tg-ullm thamt" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 52.6333px; text-align: center; height: 50px;"><span style="color: #000000;">0</span></td>
				<td class="tg-ullm thamt" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 65.9167px; text-align: center; height: 50px;"><span style="color: #000000;">0</span></td>
				<td class="tg-ullm thamt" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 111.9px; text-align: center; height: 50px;"><span style="color: #000000;">'.$decodedData[$productArray]->additionalTax.'</span></td>
				<td class="tg-ullm thamt" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 111.9px; text-align: center; height: 50px;"><span style="color: #000000;">'.$additionalTaxValue[$productArray].'</span></td>
				<td class="tg-ullm thamt" style="font-size: 12px; padding: 5px; color: #e1e1e1; width: 111.9px; text-align: center; height: 50px;"><span style="color: #000000;">'.$total[$productArray].'</span></td>
				</tr>';
				 $index++;
				 $totalAmount=$totalAmount+$total[$productArray];
				 $totalAdditionalTax=$totalAdditionalTax+$additionalTaxValue[$productArray];
