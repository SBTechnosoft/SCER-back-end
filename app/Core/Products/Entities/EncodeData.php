...
class EncodeData extends ProductCategoryService 
{
    ...
    public function getEncodedData($status)
	{
		...
		$data['address1'] = $getBranchDetails['address1'];	
		$data['address2'] = $getBranchDetails['address2'];	
		$data['pincode'] = $getBranchDetails['pincode'];	
		$data['bIs_display'] = $getBranchDetails['is_display'];	
		$data['bIs_default'] = $getBranchDetails['is_default'];	
		$data['bCreated_at'] = $getBranchDetails['created_at'];	
		$data['bUpdated_at'] = $getBranchDetails['updated_at'];	
		$data['bState_abb'] = $getBranchDetails['state_abb'];	
		$data['bCity_id'] = $getBranchDetails['city_id'];	
		$data['bCompany_id'] = $getBranchDetails['company_id'];	
		$data['bCity_name'] = $getBranchDetails['city_name'];	
		$data['bCompany_name'] = $getBranchDetails['company_name'];	
		$data['bState_name'] = $getBranchDetails['state_name'];	
